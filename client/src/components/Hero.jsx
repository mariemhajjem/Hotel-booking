...
const Hero = () => {
  ...
  const { navigate, getToken, setSearchedCities, axios } = useAppContext();
  ...
  return (
    <div className='flex flex-col items-start justify-center px-6 md:px-15 lg:px:24 xl:px:32 
      ...
      <p className='max-w-130 mt-2 text-sm md:text-base'>Unparalleled luxury and comfort</p>
      ...
      <form onSubmit={onSearch} className='bg-white text-gray-500 rounded-lg px-6 py-4 mt-8 flex flex-col md:flex-row max-md:items-start gap-4 max-md:mx-auto'>
        <div>
          ...
          <input onChange={(e) => setDestination(e.target.value)} value={destination} list='destinations' id="destinationInput" type="text"
