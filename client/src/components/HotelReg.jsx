...
export const HotelReg = () => {
   ...
   const onSubmitHandler = async (e) => {
      try {
         ...
         toast.error(error.message || "An error occurred while registering the hotel")
      }
   }
           ...
           hidden md:block' />
            ...
            <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
               ...
               <div className='w-full mt-4'>
                  ...
                  <input id='contact' onChange={(e) => setContact(e.target.value)} value={contact} type="text" placeholder="Type here" className="border
               border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 
               font-light" required />
               </div>
               ...
               <div className='w-full mt-4 max-w-60 mr-auto'>
                  ...
                  <select id="city" onChange={(e) => setCity(e.target.value)} value={city} className="border
               border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 
               font-light" required>
