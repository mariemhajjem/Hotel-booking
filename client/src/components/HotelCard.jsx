...
const HotelCard = ({ room, index }) => {
    ...
    return (
        ...
        rounded-xl overflow-hidden bg-white text-gray-500/90 shadow-[0px_4px_4px_rgba(0,0,0,0.05)]'>
            <img src={room.images[0]} alt='room-img' />
            ...
            <div className='p-4 pt-5'>
                <div className='flex items-center justify-between'>
                    ...
                    <div className='flex items-center gap-1'>
                        <img src={assets.starIconFilled} alt='star-icon' /> 4
                    </div>
                </div>
                ...
                <div className='flex items-center justify-between mt-4'>
                    <p><span className='text-xl text-gray-800'>{room.pricePerNight} {` ${currency}`}</span>/night</p>
